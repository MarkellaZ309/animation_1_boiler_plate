...
# colors
background_color = 250,131,153

# initializing pygame, setting up the surface (canvas)
pygame.init()
canvas = pygame.display.set_mode((width, height))
pygame.display.set_caption("Mindy Game") # add a caption for your canvas

# import assets
sprite_sheet = pygame.image.load("Animation_Project_1.png").convert_alpha() # add the path/name of your sprite sheet file
